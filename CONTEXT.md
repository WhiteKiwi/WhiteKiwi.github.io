...
- 핵심 텍스트·캐릭터·장면 전환은 스크롤에 직접 반응시키고, 물·잎·꽃잎·공기·상태 안내처럼 서사를 방해하지 않는 요소는 ambient loop로 살아 있게 만든다.
...
- 에이임팩트의 어레인지 농장 장면에는 물뿌리개에서 계속 떨어지는 물과 당근을 포함한 작물 잎의 흔들림을 더해 생동감을 높인다.
- 에이임팩트에서 당근으로 넘어갈 때는 밭에서 수확한 당근의 오렌지색이 화면 전체로 커지고, 다음 동네 지도를 여는 양방향 원형 매치컷을 사용한다.
